 ...
 */
@Component
public class ConfigCheck3 {

    @Value("${absolutePath}")
    private String absolutePath;

    private static final Logger log = LoggerFactory.getLogger(ConfigCheck3.class);
    ...
    private void loadConfigFile() throws IOException {
        String configFilePath= absolutePath + File.separator + "configOfCheck.properties";
        ...
        if (configFile.exists() && configFile.isFile() && configFile.length() > 0) {
            ...
            String backupConfigFilePath = absolutePath + File.separator + "back" + File.separator + "configOfCheck.properties";
